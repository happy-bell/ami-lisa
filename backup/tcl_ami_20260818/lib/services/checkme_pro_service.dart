...
/// TCLアミ専用。Checkme Pro のチェックモニター配信を受信する。
/// ラズパイ版・スタッフでは start しない。Ring と BLE アダプタを排他する。
...
class CheckmeProService extends ChangeNotifier {
  ...
  Future<void> _runLoop() async {
    ...
    while (_started) {
      try {
        if (_paused || AppManager.isPiTvLayout || !userEnabled) {
